...
const ComoFunciona = () => {
  return (
    <section className="flex flex-col items-center w-screen h-screen mb-10 bg-[#EBEBEB]">
      <div className="flex flex-col gap-16 items-center w-full max-w-[1440px] text-center">
        <div className="text-center">
          <h2 className="text-[28px] font-bold mt-16">Como Funciona</h2>
